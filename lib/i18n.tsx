  ...
  en: {
    ...
    events: {
      ...
      bookingModal: {
        ...
        bkashDetails: "bKash (Personal): 01712201434",
    ...
    footer: {
      ...
      address: "Atul Chandra market (2nd floor) Near al haramain Hospital, Subanighat road, Sylhet",
      phone: "01712201434 (Whatsapp/Call)",
    ...
    about: {
      ...
      title: "Our Story &",
      titleAccent: "Journey",
      description: "Founded with a passion for exploration, Travel Aid has become the benchmark for luxury and adventure travel in the region.",
      ...
      founderQuote: "We started Travel Aid to share the raw beauty of our country that often goes unnoticed by the world.",
  ...
  bn: {
    ...
    events: {
      ...
      bookingModal: {
        ...
        bkashDetails: "বিকাশ (পার্সোনাল): ০১৭১২২০১৪৩৪",
    ...
    footer: {
      ...
      address: "অতুল চন্দ্র মার্কেট (২য় তলা), আল হারমাইন হাসপাতালের কাছে, সুবহানীঘাট রোড, সিলেট",
      phone: "০১৭১২২০১৪৩৪ (হোয়াটসঅ্যাপ/কল)",
      email: "sahid@gmail.com",
      links: {
    ...
    about: {
      ...
      titleAccent: "যাত্রা",
      description: "অন্বেষণের প্রতি গভীর ভালোবাসা থেকে জন্ম নেওয়া Travel Aid আজ এই অঞ্চলের বিলাসবহুল এবং রোমাঞ্চকর ভ্রমণের মানদণ্ডে পরিণত হয়েছে।",
      ...
      founderQuote: "আমরা Travel Aid শুরু করেছি আমাদের দেশের সেই আদিম সৌন্দর্য সবার মাঝে ছড়িয়ে দিতে যা প্রায়ই বিশ্বের নজরের বাইরে থেকে যায়।",
