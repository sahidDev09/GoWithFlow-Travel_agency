...
const translations: Record<Language, TranslationSet> = {
  en: {
    ...
    about: {
      ...
      title: "Our Story &",
      titleAccent: "Journey",
      description: "Founded with a passion for exploration, Travel trip of sylhet has become the benchmark for luxury and adventure travel in the region.",
      ...
      founderQuote: "We started Travel trip of sylhet to share the raw beauty of our country that often goes unnoticed by the world.",
  ...
  bn: {
    ...
    about: {
      ...
      titleAccent: "যাত্রা",
      description: "অন্বেষণের প্রতি গভীর ভালোবাসা থেকে জন্ম নেওয়া Travel trip of sylhet আজ এই অঞ্চলের বিলাসবহুল এবং রোমাঞ্চকর ভ্রমণের মানদণ্ডে পরিণত হয়েছে।",
      ...
      founderQuote: "আমরা Travel trip of sylhet শুরু করেছি আমাদের দেশের সেই আদিম সৌন্দর্য সবার মাঝে ছড়িয়ে দিতে যা প্রায়ই বিশ্বের নজরের বাইরে থেকে যায়।",
